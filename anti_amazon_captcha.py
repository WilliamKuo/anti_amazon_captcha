...
def anti_amazon_captcha(image_path):
    ...
    while len(separator_index_list) != 7:
        retry_count += 1
        if threshold >= 255 or threshold <= 0 or retry_count >= 15:
...
print('{} == {}'.format(anti_amazon_captcha('amazon_captcha4.jpg'), 'GRJBUY'))  # fail  # noqa
...
print('{} == {}'.format(anti_amazon_captcha('amazon_captcha11.jpg'), 'UUGEYE'))  # crop infinity loop  # noqa
